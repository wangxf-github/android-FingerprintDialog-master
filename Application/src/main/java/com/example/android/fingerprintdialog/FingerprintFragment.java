...
public class FingerprintFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fingerprintView =  inflater.inflate(R.layout.activity_main, container, false);
        initView();
    ...
    protected void initView() {
        ...
        Button purchaseButton = (Button) fingerprintView.findViewById(R.id.purchase_button);
        Button purchaseButtonNotInvalidated = (Button) fingerprintView.findViewById(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            fingerprintView.findViewById(R.id.purchase_button_not_invalidated_description)
    ...
    private void showConfirmation(byte[] encrypted) {
        fingerprintView.findViewById(R.id.confirmation_message).setVisibility(View.VISIBLE);
        if (encrypted != null) {
            TextView v = (TextView) fingerprintView.findViewById(R.id.encrypted_message);
    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            fingerprintView.findViewById(R.id.confirmation_message).setVisibility(View.GONE);
            fingerprintView.findViewById(R.id.encrypted_message).setVisibility(View.GONE);
            ...
            if (initCipher(mCipher, mKeyName)) {
                ...
                FingerprintAuthenticationDialog fragment
                        = new FingerprintAuthenticationDialog(view.getContext());
                ...
                if (useFingerprintPreference) {
                    ...
                    fragment.setStage(
                            FingerprintAuthenticationDialog.Stage.DISABLE);
                }
                fragment.show();
            } else {
